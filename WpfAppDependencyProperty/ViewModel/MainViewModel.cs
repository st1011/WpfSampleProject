using MvvmLibrary;
using System;
using WpfAppDependencyProperty.Config;

namespace WpfAppDependencyProperty.ViewModel
{
    public class MainViewModel : NotifyObject, IDisposable
    {
        ...
        public bool TextBoxEnable
        {
            ...
            set { SetProperty(ref _textBoxEnable, value); }
        }
        ...
        public DelegateCommand ChangeEnable
        {
            get
            {
                if (_changeEnable == null)
                {
                    _changeEnable = new DelegateCommand(
                        () => {
                            TextBoxEnable = !TextBoxEnable; 
                        },
                        () => true
                    );
                }
        ...
        private DelegateCommand _changeEnable;
